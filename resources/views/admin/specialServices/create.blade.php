...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <form class="bg-dark text-white" action="{{ route('admin.specialServices.store', $service->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <input type="hidden" value="{{ route('upload.specialService.image.create', ['_token' => csrf_token()]) }}" id="upload_url">
